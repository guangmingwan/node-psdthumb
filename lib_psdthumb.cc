...
int psd2thumb(const char* in_filename,const char* out_filename) {
	...
	in_data = (char*)malloc(sizeof(char) * in_filesize + 1);
	...
	out_data = (char*)malloc(sizeof(char) * out_filesize + 1);
